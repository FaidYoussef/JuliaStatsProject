...
obs = GVs_dict[2.08].IND_COL_1.VALEUR_CHAUD
times = GVs_dict[2.08].IND_COL_1.HEURES_MAT
insert!(obs, 1, 0.)
insert!(times, 1, 0.)
...
delta_t = delta2(1, [times[1:2], times[3:end]])
k = 1
obsVect = [obs[1:2], obs[3:end]]
...
GVs_dict[2.08].IND_COL_1.VALEUR_CHAUD
delta_t

scatter(times, obs)

psARD1 = WienerARD1(mu, s2, 10e4, 2000, rho, [167231.0] )
simulate!(psARD1)

GVs_dict[2.08].maintenances